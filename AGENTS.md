...
Do not commit local databases, credentials, or machine-specific ACP agent paths. Prefer documented environment overrides such as `INFI_DB_PATH`, `CODEX_ACP_BIN`, and `INFI_CUSTOM_AGENT` for local configuration.
