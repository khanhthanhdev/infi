...
Only the latest released version of Infi receives security updates. The project is pre-1.0, and older releases are considered unsupported once a newer tag ships.
...
- The Infi desktop application (Rust backend, React frontend, Tauri shell).
